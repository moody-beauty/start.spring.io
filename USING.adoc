...
Go to https://start.spring.io, change the `Group` field from "com.moodybeauty" to "org.acme"
...
the usual UI except that the `Group` field is not equal to the usual `com.moodybeauty`
default.
